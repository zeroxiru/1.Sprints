...
class TimerApp(QMainWindow):
    ...
    def update_timer(self):
        ...
        try:
            ...
            if hasattr(self,
                       'target_window_title') and active_window and self.target_window_title in active_window.title:
                self.start_timer()
            else:
                self.stop_timer()
            ...
            print(QTimer.singleShot(1000, self.update_timer))
    ...
    def init_ui(self):
        ...
        QTimer.singleShot(1000, self.update_timer)  # Move this line here
